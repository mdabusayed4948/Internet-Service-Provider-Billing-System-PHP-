...
<div class="box box-default">
        ...
        <h3 class="box-title">Total Income Information </h3>    
        ...
        <div class="row">
          ...
          <div style="background-color: gray; text-align: center; font-size: 25px; color: #1D3777; font-weight: bold">
            Total Income :
            <?php
            $all_income =  $db->query("select sum(amount) from bf_income");
 ...
 <div class="">
  ...
  <table id="example1" class="table table-bordered table-striped">
         ...
         date_default_timezone_set("Asia/Dhaka");
         	  ...
         	  $income_table = $db->query("select i.id,i.amount,i.income_date,s.name from bf_income as i, bf_source as s where s.id=i.source_id");
